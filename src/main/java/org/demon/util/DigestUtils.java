...
public class DigestUtils {
     ...
     * @throws IllegalArgumentException when a {@link NoSuchAlgorithmException} is caught,
     * which should never happen because MD2 is a
     *                                  built-in algorithm
     ...
     * @throws IllegalArgumentException when a {@link NoSuchAlgorithmException} is caught,
     * which should never happen because MD5 is a built-in algorithm
     ...
     * @throws IllegalArgumentException when a {@link NoSuchAlgorithmException} is caught,
     * which should never happen because SHA-1 is a built-in algorithm
     ...
     * @throws IllegalArgumentException when a {@link NoSuchAlgorithmException} is caught,
     * which should never happen because SHA-256 is a built-in algorithm
     ...
     * @throws IllegalArgumentException when a {@link NoSuchAlgorithmException} is caught,
     * which should never happen because SHA-384 is a built-in algorithm
     ...
     * @throws IllegalArgumentException when a {@link NoSuchAlgorithmException} is caught,
     * which should never happen because SHA-512 is a built-in algorithm
     ...
     * Calculates the MD2 digest and returns the value as a 16 element <code>byte[]</code>.
     *
     * @param data Data to digest; converted to bytes using {@link StringUtil#getBytesUtf8(String)}
     * @return MD2 digest
     * @since 1.7
     */
